package com.weever.rotp_cm.client.render;
...
public class CMModel extends HumanoidStandModel<CMEntity> {
...
//				.build(idlePose));
	...
	@Override
	protected ModelPose<CMEntity> initIdlePose() {
	...
	@Override
	protected ModelPose<CMEntity> initIdlePose2Loop() {
		return new ModelPose<>(new RotationAngle[] {
				RotationAngle.fromDegrees(leftArm, 0, 5, -2.5215),
				RotationAngle.fromDegrees(rightArm, -0.329, -7.4928, 2.5215),
		});

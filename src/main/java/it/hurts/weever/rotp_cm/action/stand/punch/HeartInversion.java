...
import it.hurts.weever.rotp_cm.GameplayHandler;
    ...
    public StandEntityPunch punchEntity(StandEntity stand, Entity target, StandEntityDamageSource dmgSource) {
        if (target != null && target instanceof LivingEntity) {
            ...
            if (!livingEntity.hasEffect(InitEffects.CM_INVERSION.get()))
                livingEntity.addEffect(new EffectInstance(InitEffects.CM_INVERSION.get(), 150, GameplayHandler.getHeartInversionDamage(), false, false, true));
        }
